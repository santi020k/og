...
synchronized examples and complete v0.5 references for metadata, JSON-LD, built-site auditing,
...
and remaining custom-renderer responsibilities. `santi-og upgrade --to 0.5.0` updates regular
