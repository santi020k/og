...
synchronized examples and complete v0.4 references for metadata, framework-neutral content, typed
catalogs, typography, caching, CLI automation, Sharp, and Satori.
