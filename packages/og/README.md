...
synchronized examples and complete v0.6 references for metadata, JSON-LD, built-site auditing,
...
The optional `@santi020k/og/schema` entry point provides typed recipes for websites, articles,
software applications, breadcrumbs, collections, people, and organizations. `defineSchema`,
...
rules from `@santi020k/og/audit/rules`.
...
and remaining custom-renderer responsibilities. `santi-og upgrade --to 0.6.0` updates regular
